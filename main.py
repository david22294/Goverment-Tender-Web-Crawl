            ...
            if len(itemColumn)<2:
                ...
                if orgId == None:
                    ...
                    for item in items:
                        ...
                        tenderMethod.append(column[4].text.replace('\t','').replace('\n','').replace('\r',''))
                        tenderType.append(column[5].text.replace('\t','').replace('\n','').replace('\r',''))
                        annouceDate.append(column[6].text.replace('\t','').replace('\n','').replace('\r',''))
                        deadline.append(column[7].text.replace('\t','').replace('\n','').replace('\r',''))
                        money.append(column[8].text.replace('\t','').replace('\n','').replace('\r','')) 
                        trendHref.append("https://web.pcc.gov.tw/tps{i}\n".format(i=column[2].find("a").get("href")[2:]))
                        time.sleep(1)
